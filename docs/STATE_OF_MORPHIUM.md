...
|:--|:--|:--|
| 1 | **Single-layer test chips** (E, L, EM, PM each standalone) — specs generated by [`tools/testchip.py`](../tools/testchip.py): recipe, process temp, predicted metric + falsification band, metrology method | confirm champion metrics in-house (Hall µ, P-E loops, d33, ellipsometry) vs the simulated bands |
